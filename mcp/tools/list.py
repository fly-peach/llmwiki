...
def register(mcp: FastMCP, get_user_id, fs_factory, allowed_tools: set[str] | None = None) -> None:
    allowed = allowed_tools or {'create_knowledge_base', 'list_knowledge_bases'}

    if 'create_knowledge_base' in allowed:
        @mcp.tool(
    ...
    if 'list_knowledge_bases' in allowed:
        @mcp.tool(
